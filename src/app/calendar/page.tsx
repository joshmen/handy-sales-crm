...
export default function CalendarPage() {
  ...
  // ✅ ESTOS SON LOS MANEJADORES QUE FALTABAN:
  ...
  const handleVisitClick = (visit: Visit) => {
    console.log("Visita clickeada:", visit);
        ...
        <Card>
          <div className="p-6 border-b">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <Button onClick={handleProgramarVisita}>
                  + Programar visita
                </Button>
          ...
          <CardContent>
            <CalendarView
              ...
              onDateSelect={handleDateSelect} // ✅ CONECTADO
              onVisitClick={handleVisitClick} // ✅ CONECTADO
