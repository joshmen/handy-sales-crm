...
export default function RouteClosePage() {
  ...
  const [returnedProducts, setReturnedProducts] = useState<Array<{
    productId: string;
    quantity: number;
    reason: string;
  }>>([]);
  ...
  const processRouteClose = () => {
    ...
    const expectedCash = closeSummary.initialCash + closeSummary.cashSales - expenses.reduce((sum, e) => sum + e.amount, 0);
    const difference = cashTotal - expectedCash;
    
    if (Math.abs(difference) > 1) {
      if (!confirm(`Hay una diferencia de $${Math.abs(difference).toFixed(2)} en el efectivo. ¿Continuar con el cierre?`)) {
        return;
      }
    }
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              Conciliación y cierre de rutas comerciales
            </p>
          </div>
          {closeSummary && (
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center p-3 bg-gray-50 rounded-lg">
                        <p className="text-2xl font-bold text-gray-900">{closeSummary.totalVisits}</p>
                        <p className="text-sm text-gray-600">Totales</p>
                      </div>
                      <div className="text-center p-3 bg-green-50 rounded-lg">
                        <p className="text-2xl font-bold text-green-600">{closeSummary.completedVisits}</p>
                        <p className="text-sm text-gray-600">Completadas</p>
                      </div>
                      <div className="text-center p-3 bg-red-50 rounded-lg">
                        <p className="text-2xl font-bold text-red-600">{closeSummary.cancelledVisits}</p>
                        <p className="text-sm text-gray-600">Canceladas</p>
                      </div>
                      <div className="text-center p-3 bg-yellow-50 rounded-lg">
                        <p className="text-2xl font-bold text-yellow-600">{closeSummary.pendingVisits}</p>
                    ...
                    <div className="mt-4 pt-4 border-t">
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-semibold text-green-600">{closeSummary.efficiency}%</span>
                      </div>
                      <div className="flex justify-between items-center mt-2">
                        <span className="text-sm text-gray-600">Tasa de conversión</span>
                        <span className="text-lg font-semibold text-blue-600">{closeSummary.conversionRate}%</span>
                      </div>
                    </div>
                  </div>
                </Card>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills1000: parseInt(e.target.value) || 0})}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills500: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills200: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills100: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills50: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, bills20: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, coins10: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, coins5: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, coins2: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setCashCount({...cashCount, coins1: parseInt(e.target.value) || 0})}
                          className="text-center"
                        />
                      </div>
                    </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center pb-3 border-b">
                        ...
                        <span className="font-medium">${closeSummary.initialCash.toLocaleString()}</span>
                      </div>
                      
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Ventas en Efectivo</span>
                        <span className="font-medium text-green-600">+${closeSummary.cashSales.toLocaleString()}</span>
                      </div>
                      
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Ventas a Crédito</span>
                        <span className="font-medium text-blue-600">${closeSummary.creditSales.toLocaleString()}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-lg font-bold">
                          ${(closeSummary.initialCash + closeSummary.cashSales - totalExpenses).toLocaleString()}
                        </span>
                      </div>
                      ...
                      <div className={`flex justify-between items-center p-3 rounded-lg ${
                        Math.abs(cashTotal - (closeSummary.initialCash + closeSummary.cashSales - totalExpenses)) > 1
                          ? "bg-red-50"
                          : "bg-green-50"
                      }`}>
                        ...
                        <span className={`text-lg font-bold ${
                          ...
                          ${(cashTotal - (closeSummary.initialCash + closeSummary.cashSales - totalExpenses)).toLocaleString()}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className="font-medium text-green-600">{closeSummary.soldInventory} u.</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Devuelto</span>
                        <span className="font-medium text-yellow-600">{closeSummary.returnedInventory} u.</span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-sm text-gray-600">Dañado</span>
                        <span className="font-medium text-red-600">{closeSummary.damagedInventory} u.</span>
                      </div>
                      <div className="flex justify-between items-center pt-3 border-t">
                        <span className="font-medium">Restante</span>
                        <span className="text-lg font-bold">
                          {closeSummary.initialInventory - closeSummary.soldInventory - closeSummary.damagedInventory} u.
                        </span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div>
                        <div className="flex justify-between items-center mb-1">
                          ...
                          <span className="text-sm font-medium">{closeSummary.conversionRate}%</span>
                        </div>
                        <div className="w-full bg-gray-200 rounded-full h-2">
                          <div
                            className="bg-blue-500 h-2 rounded-full"
                      ...
                      <div className="flex justify-between items-center pt-3 border-t">
                        ...
                        <span className="font-semibold">${closeSummary.avgTicket.toLocaleString()}</span>
                      </div>
                    </div>
                  </div>
                </Card>
