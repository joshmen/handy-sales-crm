          ...
          <>
            <div className="flex items-start justify-between mb-6">
              ...
              <div className={`px-3 py-1 rounded-full text-xs font-medium ${
                ...
                {productFamily?.isEnabled ? 'Habilitada' : 'Deshabilitada'}
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>{productFamily?.isEnabled ? 'Habilitada' : 'Deshabilitada'}</span>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-green-50 p-3 rounded-lg text-center">
                      ...
                      <div className="text-xs text-gray-600">Habilitados</div>
                    </div>
                    <div className="bg-gray-50 p-3 rounded-lg text-center">
                      ...
                      <div className="text-xs text-gray-600">Deshabilitados</div>
                    </div>
                  </div>
                </div>
              </div>
