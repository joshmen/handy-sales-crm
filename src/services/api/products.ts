...
class ProductService {
  ...
  async createProduct(productData: CreateProductRequest): Promise<Product> {
    try {
      const response = await api.post<ApiResponse<Product>>(this.basePath, productData);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async updateProduct(productData: UpdateProductRequest): Promise<Product> {
    try {
      ...
      const response = await api.put<ApiResponse<Product>>(`${this.basePath}/${id}`, updateData);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async getOutOfStockProducts(): Promise<Product[]> {
    try {
      const response = await api.get<ApiResponse<Product[]>>(`${this.basePath}/out-of-stock`);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async getProductStats(): Promise<ProductStatsResponse> {
    try {
      const response = await api.get<ApiResponse<ProductStatsResponse>>(`${this.basePath}/stats`);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async getCategories(): Promise<string[]> {
    try {
      const response = await api.get<ApiResponse<string[]>>(`${this.basePath}/categories`);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async getFamilies(): Promise<string[]> {
    try {
      const response = await api.get<ApiResponse<string[]>>(`${this.basePath}/families`);
      return handleApiResponse(response);
    } catch (error) {
      throw handleApiError(error);
    }
  ...
  async exportProducts(format: 'csv' | 'excel' = 'csv'): Promise<Blob> {
    try {
      const response = await api.get<Blob>(`${this.basePath}/export?format=${format}`, {
        responseType: 'blob' as const,
      });
      return response.data; // <- ya es Blob
    } catch (error) {
      throw handleApiError(error);
    }
  }
  ...
  async importProducts(
    ...
    try {
      ...
      const response = await api.post<
        ApiResponse<{ message: string; imported: number; errors: string[] }>
