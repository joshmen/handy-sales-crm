...
<table width=""600"" cellpadding=""0"" cellspacing=""0"" style=""background:#fff;border-radius:8px;overflow:hidden"">
  <tr><td style=""background:#16A34A;padding:24px 32px"">
    <span style=""color:#fff;font-size:22px;font-weight:700"">HandySuites</span>
  </td></tr>
  ...
  <tr><td style=""padding:16px 32px;background:#f9fafb;border-top:1px solid #e5e7eb"">
    <p style=""margin:0;color:#9ca3af;font-size:12px"">Este es un mensaje automático de HandySuites. No responda a este correo.</p>
  </td></tr>
</table>
</td></tr></table>
</body></html>";
    ...
    <p style=""color:#374151;line-height:1.6"">Su suscripción de HandySuites vence en <strong>{daysLeft} día(s)</strong> ({expirationDate:dd/MM/yyyy}).</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola, equipo de <strong>{companyName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">Su suscripción de HandySuites ha expirado. Su cuenta entrará en un período de gracia durante el cual podrá seguir accediendo al sistema con funcionalidad limitada.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola, equipo de <strong>{companyName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">Su cuenta de HandySuites ha sido desactivada. Ya no podrá acceder al sistema hasta que su cuenta sea reactivada.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola, equipo de <strong>{companyName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">No pudimos procesar el pago de su suscripción de HandySuites{(string.IsNullOrEmpty(lastFour) ? "" : $" (tarjeta terminada en {lastFour})")}.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Gracias por su confianza en HandySuites.</p>");

    public static string WelcomeNewTenant(string companyName, string adminName)
        => Wrap("Bienvenido a HandySuites", $@"
    <p style=""color:#374151;line-height:1.6"">Hola <strong>{adminName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">¡Bienvenido a HandySuites! Su empresa <strong>{companyName}</strong> ha sido registrada exitosamente.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Has sido invitado a unirte al equipo de <strong>{companyName}</strong> en HandySuites.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola <strong>{userName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">Recibimos una solicitud para restablecer la contraseña de su cuenta de HandySuites.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola, equipo de <strong>{companyName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">Llevas 3 días en HandySuites. Un buen primer paso es <strong>configurar tu catálogo de productos</strong> con precios, categorías y familias.</p>
    ...
    <p style=""color:#374151;line-height:1.6"">Hola, equipo de <strong>{companyName}</strong>,</p>
    <p style=""color:#374151;line-height:1.6"">Ya llevas una semana con HandySuites. Es momento de <strong>crear tu primera ruta de ventas</strong> y asignar clientes a tus vendedores.</p>
