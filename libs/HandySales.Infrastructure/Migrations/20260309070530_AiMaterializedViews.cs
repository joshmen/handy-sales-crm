...
{
    /// <inheritdoc />
    public partial class AiMaterializedViews : Migration
    {
        /// <inheritdoc />
...
");
            ...
            // 2. MV: Suggested products per client (top by frequency, last 90 days)
            migrationBuilder.Sql(@"
...
");
            ...
            // 3. MV: Collection priority (urgency score per client with pending balance)
            migrationBuilder.Sql(@"
...
");
            ...
            // 4. MV: Average visit duration per client (last 90 days)
            migrationBuilder.Sql(@"
...
");
            ...
            // 5. MV: Order history averages per product/client (anomaly detection)
            migrationBuilder.Sql(@"
...
");
            ...
            // 6. MV: Average order total per client (anomaly detection)
            migrationBuilder.Sql(@"
...
");
            ...
            // 7. MV: Demand forecast (weighted moving average, 12 weeks)
            migrationBuilder.Sql(@"
...
");
            ...
            // 8. MV: Payment risk score per client (180 days history)
            migrationBuilder.Sql(@"
...
");
            ...
            // 10. Additional indexes for AI queries
            migrationBuilder.Sql(@"
...
");
        ...
        {
            migrationBuilder.Sql("DROP FUNCTION IF EXISTS refresh_ai_materialized_views();");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_payment_risk;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_demand_forecast;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_order_total_avg;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_order_history_avg;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_visit_duration_avg;");
            migrationBuilder.Sql("DROP MATERIALIZED VIEW IF EXISTS mv_collection_priority;");
