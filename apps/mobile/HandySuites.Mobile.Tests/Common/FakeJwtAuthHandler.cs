...
/// <summary>
/// Fake JWT auth handler para Mobile API tests.
/// Mismo contrato que apps/api/tests/HandySuites.Tests/Integration/Common/FakeJwtAuthHandler.cs:
/// permite override de identity via headers:
///   X-Test-UserId, X-Test-TenantId, X-Test-Role, X-Test-SuperAdmin, X-Test-Unauthenticated
/// </summary>
