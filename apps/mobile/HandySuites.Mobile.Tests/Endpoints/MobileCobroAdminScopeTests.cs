...
/// El CobroService es el que mapea Role â†’ scope query: ADMIN/SUPERVISOR/SUPER_ADMIN
...
///     puede el ADMIN del tenant 1 leer cobros del tenant 2 vÃ­a param injection
///     (no hay param de tenant en el endpoint â€” verificamos que el service usa SIEMPRE _tenant.TenantId).
...
#pragma warning restore CS0618
    ...
    // ObtenerCobrosAsync â€” scope por rol
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

    [Fact]
    public async Task ObtenerCobros_AsAdmin_DoesNotForceUsuarioIdFilter()
    {
        // Arrange â€” ADMIN tenant 1, sin pasar usuarioId
        ...
        // Assert â€” ADMIN ve cobros de OTROS vendedores (99, 88) sin filtrar
    ...
    public async Task ObtenerCobros_AsSupervisor_DoesNotForceUsuarioIdFilter()
    {
        ...
        // Sprint pre-prod #11 â€” comportamiento documentado: SUPERVISOR ve cobros
        // del equipo, no solo los suyos. Si esto cambia (a "solo su equipo"),
        // este test fallarÃ¡ y deberÃ¡ adaptarse junto al fix de service.
    ...
    {
        // RBAC NEGATIVO â€” IDOR self-elevation: VENDEDOR 50 intenta leer cobros del vendedor 99.
        ...
        // Act â€” el caller pasa usuarioId=99 con intenciÃ³n maliciosa
        await service.ObtenerCobrosAsync(usuarioId: 99);

        // Assert â€” el repo recibe 50 (su propio UserId), NO 99.
    ...
    public async Task ObtenerCobros_PassesCallerTenantId_NotOverridableByParam()
    {
        ...
        // recibe 7 â€” no existe un parÃ¡metro de tenant en el endpoint que pudiera
    ...
    {
        // ADMIN puede filtrar por clienteId (param legÃ­timo) â€” debe pasar al repo.
        var tenant = BuildTenantMock(tenantId: 1, userId: "10", role: "ADMIN");
        var repo = new Mock<ICobroRepository>();
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // ObtenerSaldosAsync / ObtenerEstadoCuentaAsync / ObtenerResumenCarteraAsync â€” scope tenant
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    // CrearAsync â€” ADMIN puede crear, IDOR cross-tenant rechazada
    // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task CrearCobro_AsAdmin_WithValidClienteAndPedido_Succeeds()
    {
        ...
        var service = new CobroService(repo.Object, tenant.Object, clienteRepo.Object, pedidoRepo.Object, Mock.Of<ISubscriptionFeatureGuard>());
    ...
    public async Task CrearCobro_AsAdmin_WithCrossTenantCliente_Throws()
    {
        ...
        // El ClienteRepository lookup pasa el TenantId del caller, asÃ­ que devuelve null.
        var tenant = BuildTenantMock(tenantId: 1, userId: "10", role: "ADMIN");
        ...
        var repo = new Mock<ICobroRepository>();
        var service = new CobroService(repo.Object, tenant.Object, clienteRepo.Object, Mock.Of<IPedidoRepository>(), Mock.Of<ISubscriptionFeatureGuard>());
    ...
    {
        // BR-050b â€” pedido vinculado al cobro debe ser del mismo cliente.
        var tenant = BuildTenantMock(tenantId: 1, userId: "10", role: "ADMIN");
    ...
    {
        // BR-050c â€” pedido cancelado no se puede cobrar.
        var tenant = BuildTenantMock(tenantId: 1, userId: "10", role: "ADMIN");
