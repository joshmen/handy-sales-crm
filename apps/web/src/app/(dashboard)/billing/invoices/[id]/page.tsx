...
const ESTADO_STYLE: Record<FacturaEstado, { key: string; color: string; bg: string }> = {
  ...
  TIMBRADA:  { key: 'stamped',  color: 'text-primary',  bg: 'bg-primary/10' },
...
export default function InvoiceDetailPage() {
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <button onClick={() => router.push('/billing/invoices')} className="px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90">
            {t('backToInvoices')}
          </button>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="bg-card px-4 sm:px-8 py-4 border-b border-border">
        <Breadcrumb items={[
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          <div className="bg-card border border-border rounded-2xl p-6 w-full max-w-md shadow-xl">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-border-default rounded-lg text-sm focus:ring-2 focus:ring-primary focus:border-primary outline-none"
            />
              ...
              {cancelMotivo === '01' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-border rounded-lg text-sm font-mono bg-background text-foreground focus:ring-2 focus:ring-primary outline-none"
                  />
