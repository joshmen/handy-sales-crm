            ...
            mobileCardRenderer={(list) => (
              <div className={!list.activo ? 'opacity-60' : ''}>
                ...
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="inline-flex items-center px-2 py-1 rounded-md bg-surface-1 text-gray-600 text-xs font-medium">{formatDate(list.actualizadoEn || list.creadoEn)}</span>
                </div>
