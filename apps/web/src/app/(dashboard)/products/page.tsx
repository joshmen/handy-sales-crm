      ...
      cellRenderer: (product) => (
        <div className="flex items-center justify-center gap-1" onClick={(e) => e.stopPropagation()}>
          ...
          {deleteConfirmId === product.id ? (
            ...
            <button onClick={() => setDeleteConfirmId(product.id)} className="p-1 text-muted-foreground hover:text-red-600 hover:bg-red-50 rounded transition-colors" title={tc('delete')}><Trash2 className="w-4 h-4" /></button>
          )}
        </div>
      ),
    },
                ...
                <div className={`${!product.isActive ? 'opacity-60' : ''}`}>
                  ...
                  <div className="mt-2.5 flex items-center justify-end gap-1 border-t border-border-subtle pt-2" onClick={(e) => e.stopPropagation()}>
                    ...
                    {deleteConfirmId === product.id ? (
                      ...
                      <button onClick={() => setDeleteConfirmId(product.id)} className="p-1.5 text-muted-foreground hover:text-red-600 hover:bg-red-50 rounded transition-colors"><Trash2 size={16} /></button>
                    )}
                  </div>
                </div>
              )}
