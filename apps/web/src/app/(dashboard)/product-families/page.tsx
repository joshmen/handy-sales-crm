            ...
            mobileCardRenderer={(family) => (
              <div className={!family.activo ? 'opacity-60' : ''}>
                ...
                <div className="flex justify-end">
                  <button onClick={() => handleOpenEdit(family)} className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-foreground/70 hover:text-blue-600 hover:bg-blue-50 rounded transition-colors">
                    <Pencil className="w-3.5 h-3.5 text-amber-400 hover:text-amber-600" /><span>{tc('edit')}</span>
                  </button>
                  <button onClick={() => handleOpenDelete(family)} className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-foreground/70 hover:text-red-600 hover:bg-red-50 rounded transition-colors">
      ...
      <Drawer
        ...
        footer={
          <div className="flex items-center justify-end gap-3" data-tour="product-families-drawer-actions">
            <Button type="button" variant="wbOutline" onClick={() => drawerRef.current?.requestClose()} disabled={savingFamily}>
              {tc('cancel')}
            </Button>
            <Button type="button" variant="wbPrimary" onClick={handleSaveFamily} disabled={savingFamily} className="flex items-center gap-2">
