...
interface ExtendedClientCategory extends ClientCategory {
  activo?: boolean;
...
const mockCategories: ExtendedClientCategory[] = [
  {
    id: 1,
    nombre: 'Mayoristas',
  ...
  },
  {
    id: 2,
    nombre: 'Minoristas',
    descripcion: 'Clientes que compran en pequeñas cantidades',
    activo: true,
  ...
  },
  {
    ...
    descripcion: 'Clientes que distribuyen productos',
    activo: true,
    productosActivos: 32,
...
export default function ClientCategoriesPage() {
  const [categories, setCategories] = useState<ExtendedClientCategory[]>([]);
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="bg-white px-8 py-6 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2 text-[13px] mb-4">
            ...
            <span className="text-gray-900">Categorías de clientes</span>
          </div>
              ...
              {loading ? (
                ...
                <div className="flex flex-col items-center justify-center h-64 py-20">
                  ...
                  <p className="text-sm text-gray-500 text-center">
                    Agrega tu primera categoría de clientes
                  </p>
                </div>
              ) : (
                <>
                  ...
                  <div className="flex items-center bg-gray-50 px-4 h-10 border-b border-gray-200">
                    ...
                    <div className="w-[100px] text-xs font-semibold text-gray-700 text-center">Clientes activos</div>
                    <div className="w-[100px] text-xs font-semibold text-gray-700 text-center">Clientes inactivos</div>
