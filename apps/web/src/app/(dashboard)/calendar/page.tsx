    ...
    <>
      <div className="p-6">
        <Card>
          <div className="p-6 border-b">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="flex gap-2">
                <Button onClick={handleProgramarVisita} data-tour="calendar-schedule-visit">+ Programar visita</Button>
                <Button variant="destructive" onClick={handleDeleteVisits}>
                  Borrar visitas
                </Button>
                <Button variant="outline" data-tour="calendar-prospect-rules">Reglas de nuevos prospectos</Button>
              </div>
            </div>
            ...
            <div className="flex gap-4 items-center">
              ...
              <Select value={selectedUser} onValueChange={setSelectedUser} data-tour="calendar-user-filter">
          ...
          <CardContent data-tour="calendar-view">
            <CalendarView
              visits={visits}
