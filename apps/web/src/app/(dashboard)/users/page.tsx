        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setIsLocationModalOpen(false)}>
          <div className="bg-white rounded-xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-hidden" onClick={e => e.stopPropagation()}>
            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h2 className="text-lg font-semibold text-gray-900">Ubicación de vendedores</h2>
                <p className="text-sm text-gray-500">Última posición conocida de cada vendedor</p>
              </div>
            ...
            <div className="p-6">
              {ubicacionesLoading ? (
                ...
                <div className="flex flex-col items-center justify-center h-[400px] text-gray-500">
                  ...
                  <p className="font-medium">Sin datos de ubicación</p>
                  <p className="text-sm">Los vendedores aún no han registrado visitas con GPS</p>
                </div>
              ) : (
                <>
                  <div className="mb-3 text-sm text-gray-600">
                    {ubicaciones.length} vendedor{ubicaciones.length !== 1 ? 'es' : ''} con ubicación registrada
                  </div>
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-gray-200 text-left text-gray-500">
                      ...
                      <th className="pb-3 font-medium">Último cliente</th>
