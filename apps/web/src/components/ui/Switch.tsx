    ...
    return (
      <label className={cn(
        ...
        <span
          ...
          style={checked ? { backgroundColor: 'var(--company-primary-color, #0176D3)' } : undefined}
        />
        <span className={cn(
          ...
          {checked && (
            <svg width="10" height="10" viewBox="0 0 10 10" fill="none" className="text-current" style={{ color: 'var(--company-primary-color, #0176D3)' }}>
