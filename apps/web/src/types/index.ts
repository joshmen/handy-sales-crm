...
export interface Product extends BaseEntity {
  ...
  category: string;
  brand?: string;
  family?: string; // ← agregado para tus mocks
  unit: string;
  price: number;
  cost?: number;
  stock: number;
...
// Route Product (para carga de inventario en rutas)
...
// Re-export catalogs types (categories, units)
export * from './catalogs';

// Re-export impersonation types
export * from './impersonation';

// Re-export visits types (API specific types)
export * from './visits';
